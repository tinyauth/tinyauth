...
class DeleteGroupPolicy extends Component {
    constructor(props) {
        super(props);
    ...
    async handleDeletePolicy(event) {
      ...
      try {
        let { status } = await request('DELETE', `/groups/${group}/policies/${policy}`);
    ...
    render() {
      return <Card>
          <ViewTitle title="Remove policy from group" />
...
DeleteGroupPolicy.propTypes = {
    dispatch: PropTypes.func.isRequired,
};

export default connect()(DeleteGroupPolicy);
